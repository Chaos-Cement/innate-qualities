...
public class TestTree extends WorldGenAbstractTree {
	    ...
	    private static final IBlockState DEFAULT_TRUNK = ModBlocks.treeElderLog.getDefaultState();
	    private static final IBlockState DEFAULT_LEAF = ModBlocks.treeElderLeaf.getDefaultState();
	    ...
	    public TestTree(boolean p_i2027_1_)
	    {
	        this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
	    }

	    public TestTree(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_)
	    {
	        super(p_i46446_1_);
