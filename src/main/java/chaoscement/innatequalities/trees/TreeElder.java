package chaoscement.innatequalities.trees;
...
public class TreeElder extends WorldGenAbstractTree {
    ...
    private static final IBlockState LOG = ModBlocks.treeElderLog.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH);
    private static final IBlockState LEAF = ModBlocks.treeElderLeaf.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(BlockOldLeaf.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public TreeElder(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
